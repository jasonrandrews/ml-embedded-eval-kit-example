...
vela mobilenet_v2_1.0_224_quantized_1_default_1.tflite --accelerator-config=ethos-u55-128 --config scripts/vela/default_vela.ini --memory-mode Shared_Sram --system-config Ethos_U55_High_End_Embedded
